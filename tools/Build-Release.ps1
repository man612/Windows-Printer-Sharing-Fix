...
foreach ($name in @('ARCHITECTURE.md','DIAGNOSTIC-JSON.md','PRINTSERVICE-EVENTS.md','POLICY-SOURCES.md','DRIVER-CLASSIFICATION.md','CORRELATION.md','MODERN-SMB-RPC.md','TEST-PAGE-VERIFICATION.md','TEST-MATRIX.md','REAL-WORLD-RESULTS.md','README.id.md')) {
