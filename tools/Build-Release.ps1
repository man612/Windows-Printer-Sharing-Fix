...
$docs = @(
    'ARCHITECTURE.md','DIAGNOSTIC-JSON.md','PRINTSERVICE-EVENTS.md','POLICY-SOURCES.md',
    'DRIVER-CLASSIFICATION.md','CORRELATION.md','MODERN-SMB-RPC.md','RELEASE-INTEGRITY.md','TEST-PAGE-VERIFICATION.md',
