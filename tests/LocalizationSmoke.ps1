...
foreach($expected in @('LAPORAN DIAGNOSIS','Peran terdeteksi: Klien','Model driver','Penyedia driver','Klien SMB1','Tidak aktif','Lapisan berikutnya untuk diperiksa','path target / transport remote','prioritas troubleshooting, bukan klaim akar penyebab','Bukti sumber kebijakan printer','Group Policy Lokal','nilai registry; sumber tidak diketahui')) {
